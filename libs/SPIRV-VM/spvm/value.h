...
extern "C" void spvm_member_set_value_f(spvm_member_t mems, size_t mem_count, float* f);
extern "C" void spvm_member_set_value_i(spvm_member_t mems, size_t mem_count,  int* d);
